...
dsn_hostname <- Sys.getenv("DATABASE_HOST") #= "172.26.67.64"
dsn_port <- Sys.getenv("DATABASE_PORT") #= "5432"                # Specify your port number. e.g. 98939
dsn_uid <- Sys.getenv("DATABASE_USER") #"mreta"         # Specify your username. e.g. "admin"
dsn_pwd <- Sys.getenv("DATABASE_PASSWORD") #= "m4nureta"        # Specify your password. e.g. "xxx"
